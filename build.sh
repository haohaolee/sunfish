...
# HolyDragon Kernel Build Script
# Version 2.0
##############################################
# Kernel zip Name
kn=HDK_Sunfish11_RV.3.0.zip

export LOCALVERSION=-HDK_Sunfish11_RV.3.0
##############################################
# Paths
##############################################
...
export CROSS_COMPILE=/android/toolchains/ggcc/bin/aarch64-linux-android-
